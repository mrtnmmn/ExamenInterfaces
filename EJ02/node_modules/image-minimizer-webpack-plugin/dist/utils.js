...
exports.imageminGenerate = imageminGenerate;
exports.imageminMinify = imageminMinify;
exports.imageminNormalizeConfig = imageminNormalizeConfig;
exports.isAbsoluteURL = isAbsoluteURL;
exports.squooshGenerate = squooshGenerate;
exports.squooshMinify = squooshMinify;
...
async function imageminGenerate(original, minimizerOptions) {
  ...
  const extInput = _path.default.extname(original.filename).slice(1).toLowerCase();
...
async function squooshGenerate(original, minifyOptions) {
  ...
  const ext = _path.default.extname(original.filename).toLowerCase();
...
async function squooshMinify(original, options) {
  ...
  const ext = _path.default.extname(original.filename).slice(1).toLowerCase();
